...
def register_blueprints(app):
    ...
    from .cuas import cuas_bp
    from .sigint import sigint_bp
    ...
    app.register_blueprint(cuas_bp)  # C-UAS detection
    app.register_blueprint(sigint_bp)  # Distributed SIGINT scanner
